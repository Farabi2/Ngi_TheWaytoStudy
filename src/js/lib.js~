function setCoord(pos) {
    if (pos.coords !== undefined) {
        ...
        var url = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=AIzaSyBkgq6skqj_3s0ME2aQHUmq6N_EJ4iADKs&location=" + latitude + "," + longitude + "&radius=1000&keyword=library&maxprice=1";
